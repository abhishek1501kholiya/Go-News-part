class Form {
  ...
  //  console.log(fName);
      ...
      this.greeting3.html('  from upload post  to tell others about the  environment condition of your  area and also tell how you are helping the environment and can also report against any one who  is throwing garbage or making environment bad from report tab');
